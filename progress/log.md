...
This file holds only the **10 newest sessions**. When a new entry pushes it past 10, the oldest moves to `log-archive.md` (done during `/wrap-up`). Entries are short: max ~6 lines, Notes max 3 sentences.
