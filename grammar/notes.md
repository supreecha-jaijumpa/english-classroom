...
Simple grammar rules, explained in plain language. Newest lessons go at the **top**. This file holds only the **5 newest lessons** — older ones move to `notes-archive.md` during `/wrap-up`, leaving a one-line index of archived topics here.
