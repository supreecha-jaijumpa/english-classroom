...
Mistakes move here from corrections.md in two ways: **mastered** (3/3 correct uses) or **rotated out** of the Active list when it grows past ~10 (oldest first, still unmastered).
...
## Rotated Out (not yet mastered — newest first)
